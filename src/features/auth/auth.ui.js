...
export class AuthUI {
      ...
      child: stac.column({
        ...
        children: [
          stac.text("Welcome", {
            ...
            textAlign: displayType === "screen" ? "center" : "start",
          }),
          stac.sizedBox({ height: 8 }),
          stac.text("Sign in to access your cart and saved items.", {
  ...
  static asScreen(title, formWidget) {
    return stac.scaffold({
      ...
      appBar: stac.appBar({ title, backgroundColor: Brand.surface, elevation: 1 }),
      body: stac.safeArea({
