...
export class CategoryUI {
  ...
  static _parentCategoryCard(cat, selectedCategoryId) {
    ...
    const tapAction = hasChildren
      ? stac.navigate(`/categories/${cat.id}/subcategories`, "push")
      : stac.navigate(`/categories/${cat.id}/products`, "push");
  ...
  // Call these from your Express routes to get JSON for the SDUI client
  // ─────────────────────────────────────────────────────────────────
